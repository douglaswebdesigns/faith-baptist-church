<div id="dh_ptp_tabs_1" class="dh_ptp_tab">
    <h4><?php _e('Prison Ministry Table Columns', 'easy-pricing-tables'); ?></h4>
    ...
    <div id="all-columns-wrap">
        <div class="column zero">
            <div class="ptp-title explaination-title">
                <strong><?php _e('Ministry', 'easy-pricing-tables'); ?></strong><i class="ptp-icon-help-circled" data-trigger="hover" data-html="true" data-placement="right" data-original-title="&lt;strong&gt;<?php _e('Plan Name', 'easy-pricing-tables');?>&lt;/strong&gt;" data-content="
            ...
            <ul class="ptp-settings explaination-settings">
                <li class="explaination-desc">
                    <strong><?php _e('Leader', 'easy-pricing-tables'); ?></strong><i class="ptp-icon-help-circled" data-trigger="hover" data-html="true" data-placement="right" data-original-title="&lt;strong&gt;<?php _e('Pricing', 'easy-pricing-tables'); ?>&lt;/strong&gt;" data-content="
					            <?php _e('Enter your pricing options here.', 'easy-pricing-tables'); ?>
					            "></i>
                </li>
                <li class="features explaination-desc">
                    <strong><?php _e('Attendance', 'easy-pricing-tables'); ?></strong><i class="ptp-icon-help-circled" data-trigger="hover" data-html="true" data-placement="right" data-original-title="&lt;strong&gt;<?php _e('Features', 'easy-pricing-tables'); ?>&lt;/strong&gt;" data-content="
        ...
        while($mb->have_fields_and_multi('column',array('length' => 2))):
            ...
            <div class="column">
                ...
                <div class="ptp-title plan-title">
                    ...
                    <input id="plan-name" type="text" name="<?php $mb->the_name(); ?>" placeholder="<?php _e('Men\'s Services', 'easy-pricing-tables'); ?>" value="<?php echo $mb->the_value(); ?>" class="form-control">
                </div>

                <ul class="ptp-settings plan-settings">
                    <li>
                        <?php $mb->the_field('planprice'); ?>
                        <input type="text" name="<?php $mb->the_name(); ?>" placeholder="<?php _e('Brother Wally', 'easy-pricing-tables'); ?>" value="<?php echo $mb->the_value(); ?>" class="form-control">
                    </li>
                    <li class="features">
                        <?php $mb->the_field('planfeatures'); ?>
						<?php
							$placeholder = array(
								str_pad(__('People Attended', 'easy-pricing-tables'), 40),
								str_pad(__('Total Services', 'easy-pricing-tables'), 40),
								str_pad(__('Souls Saved', 'easy-pricing-tables'), 40),
								str_pad(__('Hours Devoted', 'easy-pricing-tables'), 40),
							);
						?>
                    ...
                    <li>
                        ...
                        <input type="text" pla name="<?php $mb->the_name(); ?>" placeholder="<?php _e('Learn More', 'easy-pricing-tables'); ?>" value="<?php  $mb->the_value(); ?>" class="form-control">
                    </li>

                    <li>
                        <?php $mb->the_field('buttonurl'); ?>
                        <input type="text" placeholder="<?php _e('http://fbcchelsea.org/prison-services/', 'easy-pricing-tables'); ?>" name="<?php $mb->the_name(); ?>" value="<?php echo $mb->the_value();?>" class="form-control">
                    </li>
                </ul>
            </div>
