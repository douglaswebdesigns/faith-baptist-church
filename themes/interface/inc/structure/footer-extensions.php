...
function interface_footer_info() {         
   $output = '<div class="copyright">'.__( 'Copyright &copy;', 'interface' ).' '.interface_the_year().' ' .interface_site_link().' | ' . ' '.__( 'A WordPress Website&nbsp;<img src="/wp-content/themes/interface/inc/footer_info/images/wpmini-blue-dual-wolves.png" title="Looking to upgrade or build a great WordPress site? Click Here" alt="Douglas Web Designs Logo" style="margin:4px;">  by:', 'interface' ).' '.interface_themehorse_link() .' </div><!-- .copyright -->';
   echo $output;
}
/****************************************************************************************/
