...
function interface_themehorse_link() {
   return '<a href="'.esc_url( 'http://douglaswebdesigns.com' ).'" target="_blank" title="'.esc_attr__( 'Douglas Web Designs', 'interface' ).'" ><span>'.__( 'Douglas Web Designs', 'interface') .'</span></a>';
}
?>
