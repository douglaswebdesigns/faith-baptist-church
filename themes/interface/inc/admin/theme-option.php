...
function interface_options_menu() {
	...
	add_theme_page( 
		__( 'FBC Theme Options', 'interface' ),           // Name of the page
		__( 'FBC Theme Options', 'interface' ),           // Label in menu (Inside apperance)
...
<div class="them_option_block clearfix">
  <div class="theme_option_title">
    <h2>
      <?php _e( 'Faith Baptist Church Theme Options Customized by', 'interface' ); ?>
    </h2>
  </div>
  <div class="theme_option_link"><a href="<?php echo esc_url( __( 'http://douglaswebdesigns.com/', 'interface' ) ); ?>" title="<?php esc_attr_e( 'Douglas Web Designs', 'interface' ); ?>" target="_blank"><img src="<?php echo INTERFACE_ADMIN_IMAGES_URL . '/douglas-web-designs.png'; ?>" alt="'<?php _e( 'Theme Horse', 'interface' ); ?>" /></a> </div>
</div>
<br/>
<br/>
<br/>
<div class="donate-info"> <strong>
  <?php _e( 'WARNING: This Custom Website based on the Interface Theme Must Not Be Updated or The Site Will Be Broken!<br>DO NOT UPDATE Interface Theme! Douglas Web Designs - Questions?&nbsp;email:&nbsp;paul@douglaswebdesigns.com', 'interface' ); ?>
  </strong><br/>
  ...
  <div id="social-share">
    <div class="tw-follow" ><a href="<?php echo esc_url( 'http://twitter.com/pDouglasDesigns' ); ?>" class="twitter-follow-button" data-button="grey" data-text-color="#FFFFFF" data-link-color="#00AEFF" data-width="150px" data-show-screen-name="true" data-show-count="false"></a></div>
  </div>
</div>
  ...
  <form method="post" action="options.php">
    ...
    <div id="interface_tabs">
      ...
      <div id="responsivelayout">
        <div class="option-container">
          <h3 class="option-toggle"><a href="#">
            <?php _e( 'FBC Site Layout', 'interface' ); ?>
            </a></h3>
        ...
        <div class="option-container">
          <h3 class="option-toggle"><a href="#">
            <?php _e( 'FBC Content Layout', 'interface' ); ?>
            </a></h3>
          <div class="option-content inside">
            <table class="form-table">
              <tbody>
        ...
        <div class="option-container">
          <h3 class="option-toggle"><a href="#">
            <?php _e( 'FBC Responsive Layout', 'interface' ); ?>
            </a></h3>
          <div class="option-content inside">
            <table class="form-table">
              <tbody>
      ...
      <div id="designoptions">
        <div class="option-container">
          <h3 class="option-toggle"><a href="#">
            <?php _e( 'Faith Baptist Church Header', 'interface' ); ?>
            </a></h3>
          <div class="option-content inside">
            <table class="form-table">
              <tbody>
                <tr>
                  <th scope="row"><label for="header_logo">
                      <?php _e( 'FBC Header Logo', 'interface' ); ?>
                    </label></th>
                ...
                <tr>
                  <th scope="row"><?php _e( 'Hide Custom Search Box from Header', 'interface' ); ?></th>
        ...
        <div class="option-container">
          ...
          <div class="option-content inside">
            <table class="form-table">
              <tbody>
                <tr>
                  <th> <?php _e( 'Change default background and background color.', 'interface' ); ?>
                  </th>
      ...
      <div id="advancedoptions">
        <div class="option-container">
          <h3 class="option-toggle"><a href="#">
            <?php _e( 'FBC Home Slogan Options', 'interface' ); ?>
            </a></h3>
          <div class="option-content inside">
            <table class="form-table">
              <tbody>
        ...
        <div class="option-container">
          <h3 class="option-toggle"><a href="#">
            <?php _e( 'FBC Homepage Blog Category Setting', 'interface' ); ?>
            </a></h3>
          <div class="option-content inside">
            <table class="form-table">
              <tbody>
      ...
      <div id="featuredpostslider"> 
        ...
        <div class="option-container">
          <h3 class="option-toggle"><a href="#">
            <?php _e( 'Slider Options - **Use Revolution Slider Plugin**', 'interface' ); ?>
            </a></h3>
          <div class="option-content inside">
            <table class="form-table">
              <tr>
        ...
        <div class="option-container">
          <h3 class="option-toggle"><a href="#">
            <?php _e( 'Featured Post/Page Slider Options - **Use Revolution Slider Plugin**', 'interface' ); ?>
            </a></h3>
          <div class="option-content inside">
            <table class="form-table">
              <tr>
      ...
      <div id="sociallink">
        ...
        <?php 
						...
						$social_links_name = array( __( 'FBC Facebook', 'interface' ),
													__( 'FBC Twitter', 'interface' ),
													__( 'FBC Google Plus', 'interface' ),
													__( 'FBC Pinterest', 'interface' ),
													__( 'FBC Youtube', 'interface' ),
													__( 'FBC Vimeo', 'interface' ),
													__( 'FBC LinkedIn', 'interface' ),
													__( 'FBC Flickr', 'interface' ),
													__( 'FBC Tumblr', 'interface' ),
													__( 'FBC RSS', 'interface' )
													);
        ...
        <div class="option-container">
          ...
          <div class="option-content inside">
            ...
            <p>Web Leaders don't rebuild their sites every 3 years, they nourish them daily - <a href="http://douglaswebdesigns.com">Douglas Web Designs</a></p>
          </div>
        </div>
      </div>
      <!-- #sociallink --> 
