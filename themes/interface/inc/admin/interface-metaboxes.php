...
function interface_add_custom_box() {
	add_meta_box(
		...
		__( 'Select layout for this specific FBC Page only ( Note: This setting only reflects if page Template is set as Default Template and Blog Type Templates.)', 'interface' ),   	//Title
		'interface_sidebar_layout',                   							//Callback function
		'page'                                          							//show metabox in pages
	); 
	add_meta_box(
		'siderbar-layout',							  										//Unique ID
		__( 'Select layout for this specific FBC Post only', 'interface' ),   	//Title
		'interface_sidebar_layout',                   							//Callback function
