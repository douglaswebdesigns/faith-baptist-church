...
add_action( 'after_setup_theme', 'interface_editor_setup' );

function interface_editor_setup() {
		...
		add_editor_style( array( 'inc/css/editor-styles.css', str_replace( ',', '%2C', $font_url ) ) );
}

wp_enqueue_style( 'faith-baptist-google-fonts', 'http://fonts.googleapis.com/css?family=Lato:100,300,400,400italic,700,900,900italic|PT+Serif:400,700,400italic,700italic' );
...
function interface_excerpt_length( $length ) {
	return 35;  // this will return 50 words in the excerpt
}
