...
function interface_widgets_init() {
	...
	register_sidebar( array(
		'name' 				=> __( 'FBC Upper Homepage', 'interface' ),
		'id' 					=> 'interface_business_page_sidebar',
		'description'   	=> __( 'Ability to place widgets on the upper section of Home Page. eg: Testimonial, Services, PromoBox', 'interface' ),
		'before_widget' 	=> '<section id="%1$s" class="widget %2$s">',
		'after_widget'  	=> '</section>',
		'before_title'  	=> '<h1 class="large">',
		'after_title'   	=> '</h1>',
	...
	register_sidebar( array(
		'name' 				=> __( 'FBC Lower Homepage', 'interface' ),
		'id' 					=> 'interface_business_page_our_client_sidebar',
		'description'   	=> __( 'Ability to place widgets at bottom of the page. eg: Featured Image', 'interface' ),
	...
	register_sidebar( array(
		'name' 				=> __( 'About Page Widget', 'interface' ),
		'id' 					=> 'interface_contact_page_sidebar',
		'description'   	=> __( 'Ability to place widgets on About Page.', 'interface' ),
		'before_widget' 	=> '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  	=> '</aside>',
		'before_title'  	=> '<h1 class="widget-title">',
		'after_title'   	=> '</h1>'
	...
	// Registering Video Page template for our video sidebar
	register_sidebar( array(
		'name' 				=> __( 'FBC Video Page', 'interface' ),
		'id' 					=> 'interface_video_page_sidebar',
		'description'   	=> __( 'Ability to place widgets into video page. eg: Featured Videos', 'interface' ),
		'before_widget' 	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'  	=> '</div>',
		'before_title'  	=> '<h1 class="widget-title">',
		'after_title'   	=> '</h1>',
...
class interface_custom_tag_widget extends WP_Widget {
	function interface_custom_tag_widget() {
		...
		parent::WP_Widget( false, $name = __( 'Faith Baptist Church: Custom Tag Cloud', 'interface' ), $widget_ops, $control_ops );
	}
 ...
 */
 class interface_service_widget extends WP_Widget {
 	function interface_service_widget() {
		...
		$control_ops = array( 'width' => 200, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'Faith Baptist Church: Services', 'interface' ), $widget_ops, $control_ops);
 	}
...
<div class="column clearfix">
  ...
  <div class="<?php echo $service_class; ?>">
    <div class="service-item clearfix">
    	<div class="service-item-fix">
    	<a class="more-link underline" title="<?php the_title_attribute(); ?>" href="<?php the_permalink(); ?>">
      <?php 
 ...
 */
 class interface_promobox_widget extends WP_Widget {
 	function interface_promobox_widget() {
		...
		$control_ops = array( 'width' => 200, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'Faith Baptist Church: PromoBox', 'interface' ), $widget_ops, $control_ops);
 	}
...
<?php
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['widget_secondary'] = esc_html($new_instance['widget_secondary']);
 ...
 */
 class interface_recent_work_widget extends WP_Widget {
 	function interface_recent_work_widget() {
		...
		$control_ops = array( 'width' => 200, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'Faith Baptist Church: Featured Recent Work', 'interface' ), $widget_ops, $control_ops);
 	}
...
class interface_Widget_Testimonial extends WP_Widget {
	...
	function interface_Widget_Testimonial() {
		...
		$control_ops = array( 'width' => 200, 'height' =>250 ); 
		parent::WP_Widget( false, $name = __( 'Faith Baptist Church: Testimonial', 'interface' ), $widget_ops, $control_ops);
 	}
...
class interface_featured_image_widget extends WP_Widget {
	...
	function interface_featured_image_widget() {
		$widget_ops = array( 'classname' => 'widget_ourclients box-shadow-preview', 'description' => __( 'Use to show your clients logos or any thing.', 'interface') );
		$control_ops = array('width' => 200, 'height' => 250);
		parent::WP_Widget( false, $name='Faith Baptist Church: Featured Image', $widget_ops, $control_ops );
	}
