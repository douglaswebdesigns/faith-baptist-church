<?php
/**
 * Template Name: Women's Prison Services Ministry Page Full Content Display
 *
...
?>
<?php get_header(); ?>
	<div id="" class="prison-page padding">
			...
			<section>
				<div id="post-container">
					...
					<?php 
						...
						query_posts('category_name=womens-prison-services&showposts=1&orderby=date&order=ASC');
