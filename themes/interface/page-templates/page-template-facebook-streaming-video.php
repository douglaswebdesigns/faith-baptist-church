<?php
/**
 * Template Name: Facebook Streaming Video Page
 *
		    ...
		    <div class="streaming-video">		      
			    <div class="streaming-iframe">
					  ...
					  <div class="fb-video" data-href="https://www.facebook.com/facebook/videos/10153231379946729/" data-width="500" data-show-text="false">
						...
						<?php do_shortcode('[su_shadow style="default" inline="no" class=""]'); ?>
							...
							<?php
								...
								// 
								$videoID = get_post_meta($post->ID, 'facebook_video_urls', true);
								// Check if there is in fact a video URL
								if ($videoID) {
									echo '<div class="video-container">';
									// Echo the embed code via oEmbed
									echo wp_oembed_get( 'https://www.facebook.com/' . $userID . '/videos/' . $videoID ); 
									echo '</div>';
								}
							?>
					...
					<div class="notification-area">
						...
						<h3>For best picture results, set Facebook quality settings <i class="fa fa-cog" aria-hidden="true"></i> to <strong>Auto</strong></h3>
					</div>					   
