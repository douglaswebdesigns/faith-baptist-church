	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="register-section" id="basic-details-section">
				...
				<h4><?php _e( 'Account Details', 'ap3-ion-theme' ); ?></h4>

				<label for="signup_username"><?php _e( 'Username', 'ap3-ion-theme' ); ?> <?php _e( '(required)', 'ap3-ion-theme' ); ?></label>
				<?php do_action( 'bp_signup_username_errors' ); ?>
				<input type="text" name="signup_username" id="signup_username" value="<?php bp_signup_username_value(); ?>" />

				<label for="signup_email"><?php _e( 'Email Address', 'ap3-ion-theme' ); ?> <?php _e( '(required)', 'ap3-ion-theme' ); ?></label>
				<?php do_action( 'bp_signup_email_errors' ); ?>
				<input type="text" name="signup_email" id="signup_email" value="<?php bp_signup_email_value(); ?>" />

				<label for="signup_password"><?php _e( 'Choose a Password', 'ap3-ion-theme' ); ?> <?php _e( '(required)', 'ap3-ion-theme' ); ?></label>
				<?php do_action( 'bp_signup_password_errors' ); ?>
				<input type="password" name="signup_password" id="signup_password" value="" />

				<label for="signup_password_confirm"><?php _e( 'Confirm Password', 'ap3-ion-theme' ); ?> <?php _e( '(required)', 'ap3-ion-theme' ); ?></label>
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-section" id="profile-details-section">
					...
					<h4><?php _e( 'Profile Details', 'ap3-ion-theme' ); ?></h4>
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
				...
				<div class="register-section" id="blog-details-section">
					...
					<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
						...
						<label for="signup_blog_url"><?php _e( 'Blog URL', 'ap3-ion-theme' ); ?> <?php _e( '(required)', 'ap3-ion-theme' ); ?></label>
						...
						<label for="signup_blog_title"><?php _e( 'Site Title', 'ap3-ion-theme' ); ?> <?php _e( '(required)', 'ap3-ion-theme' ); ?></label>
			...
			<div class="submit">
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'ap3-ion-theme' ); ?>" />
			</div>
