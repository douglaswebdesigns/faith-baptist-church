...
<script id="tmpl-bp-avatar-delete" type="text/html">
	<# if ( 'user' === data.object ) { #>
		<p><?php _e( "If you'd like to delete your current profile photo but not upload a new one, please use the delete profile photo button.", 'ap3-ion-theme' ); ?></p>
		<p><a class="button edit" id="bp-delete-avatar" href="#" title="<?php esc_attr_e( 'Delete Profile Photo', 'ap3-ion-theme' ); ?>"><?php esc_html_e( 'Delete My Profile Photo', 'ap3-ion-theme' ); ?></a></p>
	<# } else if ( 'group' === data.object ) { #>
		<p><?php _e( "If you'd like to remove the existing group profile photo but not upload a new one, please use the delete group profile photo button.", 'ap3-ion-theme' ); ?></p>
		<p><a class="button edit" id="bp-delete-avatar" href="#" title="<?php esc_attr_e( 'Delete Group Profile Photo', 'ap3-ion-theme' ); ?>"><?php esc_html_e( 'Delete Group Profile Photo', 'ap3-ion-theme' ); ?></a></p>
	<# } else { #>
