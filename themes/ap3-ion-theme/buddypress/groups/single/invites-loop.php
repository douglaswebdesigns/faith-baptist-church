	...
	<?php if ( bp_group_has_invites( bp_ajax_querystring( 'invite' ) . '&per_page=10' ) ) : ?>
		...
		<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
			...
			<li class="item" id="<?php bp_group_invite_item_id(); ?>">
				...
				<div class="action">
					<a class="button remove" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'ap3-ion-theme' ); ?></a>
...
<div class="submit padding">
	<input type="submit" class="button button-primary" name="submit" id="submit" value="<?php esc_attr_e( 'Send Invites', 'ap3-ion-theme' ); ?>" />
</div>
